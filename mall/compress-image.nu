...
def main [
  ...
  if ($bizType == null) {
    print $'(char nl)Usage: nu compress-image.nu (ansi r)<bizType>(ansi rst)'; hr-line
    print $'(ansi g)Description: (ansi rst)根据`业务类型`压缩本地 `./client/images`、`./client/design/images` 中的图片'
  ...
  print $'Running compress images for (ansi p)($bizType)(ansi rst)...'
