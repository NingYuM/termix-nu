...
def main [
  ...
  if ($bizType == null) {
    print $'(char nl)Usage: nu get-locale.nu (ansi r)<bizType>(ansi rst)'; hr-line
    print $'(ansi g)Description: (ansi rst)根据`业务类型`从国际化文案管理平台下载最新的中英文文案到本地'
  ...
  print $'Running get locale for (ansi p)($bizType)(ansi rst)...'
