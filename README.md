...
- 如果在同步的时候想采用强制推送策略需要：`FORCE_PUSH=1 just trigger-sync ...`；
...
### 23. 查询二开仓库的远程分支及 Tag 信息{#ls-redev-refs}
...
### 25. 扫描(清理)同步仓库里面冗余分支{#prune-branches}
